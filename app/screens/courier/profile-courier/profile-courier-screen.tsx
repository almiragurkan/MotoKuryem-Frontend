  ...
  return (
    <View testID="ProfileCourierScreen" style={FULL}>
      ...
      <Screen style={CONTAINER} preset="scroll" backgroundColor={color.transparent}>
        ...
        <TouchableOpacity style={INNER_VIEW_STYLE} onPress={()=>navigation.navigate("walletCourier")}>
          <Icon style={ICON_STYLE1} icon={"wallet"}></Icon>
          <Text style={INNER_TEXT2}>Cüzdanım</Text>
        </TouchableOpacity>
        <TouchableOpacity style={INNER_VIEW_STYLE} onPress={()=>navigation.navigate("changePasswordCourier")}>
          <Icon style={ICON_STYLE1} icon={"lock"}></Icon>
          <Text style={INNER_TEXT2}>Şifreyi Değiştir</Text>
        </TouchableOpacity>
        <TouchableOpacity style={INNER_VIEW_STYLE} onPress={()=>navigation.navigate("supportCourier")}>
