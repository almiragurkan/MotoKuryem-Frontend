...
export const CouriersSentRequestToAdScreen: FC<StackScreenProps<NavigatorParamListCustomer, "couriersSentRequestToAd">> = observer(function CouriersSentRequestToAdScreen() {
